...
public class VStaticAssets {
	...
	public static class Text{		
		...
		public static final String intro3Text = "Lielākā daļa minerālu ir radušies no šķidrām \nvielām – dažāda sastāva kausējumiem un maisījumiem. Pārējo minerālu izcelšanās ir saistīta ar gāzveida vielas kristalizāciju un ķīmiskajiem aizvietošanas un pārkristalizēšanās procesiem cietās vielās.";				
		public static final String intro4Text = "Visus minerālu veidošanās procesus iedala 2 grupās: endogēnos un eksogēnos procesos.";				
		public static final String intro5Text = "Endogēnie procesi gandrīz vienmēr notiek Zemes iekšienē lielākā vai mazākā dziļumā paaugstināta spiediena un augstas temperatūras apstākļos.";
		public static final String intro6Text = "Eksogēnie minerālu veidošanās procesi notiek Zemes virspusē vai ļoti nelielā dziļumā zemas temperatūras un tāda spiediena apstākļos, kas ir tuvs atmosfēras spiedienam.";
		
		public static final String chem1 = "Malahīts";
		public static final String chem2 = "Kaolinīts";
		public static final String chem3 = "Eritrīts";
		public static final String hidro1 = "Zelts";
		public static final String hidro2 = "Galenīts";
		public static final String hidro3 = "Realgārs";
		...
		public static final String organ1 = "Organogēnais kaļķakmens";
		...
		public static final String pneim3 = "Stilbīts";
